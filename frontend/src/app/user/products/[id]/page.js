...
export default function ProductPage( ) {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <Image src={product.productImage} alt={product.productName} width={400} height={400} className="object-cover rounded border border-gray-200 relative top-40"/>
      </div>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="leading-relaxed">{product.productDiscription}</p>
